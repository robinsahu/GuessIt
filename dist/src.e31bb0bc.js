...
var winner0El = document.querySelector(".winner--0");
var winner1El = document.querySelector(".winner--1");
...
btnHold.addEventListener("click", function () {
  if (playing) {
    ...
    if (scores[activePlayer] >= 100) {
      ...
      playing = false;
      diceEl.classList.add("hidden");
      document.querySelector(".winner--".concat(activePlayer)).classList.remove("hidden");
